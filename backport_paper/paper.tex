...
\title{Characterizing and Predicting Cross-Branch porting in Open Source Projects} %
...
% 1st. author
%\alignauthor
%Lisa Hua$^{\dag}$ \hspace*{2em} Miryung Kim$^{\ast}$ \hspace*{2em} \\[.2ex]
%\affaddr{$^{\dag}$The University of Texas atAustin~~$^{\ast}$University of California, Los Angeles}\\
%\email{\normalsize{lisahua@utexas.edu,  miryung@cs.ucla.edu}}
}
