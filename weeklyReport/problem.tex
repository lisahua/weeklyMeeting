...
Hypothesis: We can find related elements by following the structural dependencies of seed API elements in code and by ranking these related API elements based on their topology structure. 
